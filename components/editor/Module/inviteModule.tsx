...
export default function InviteModule() {
  ...
  const inviteLink = `${process.env.NEXT_PUBLIC_API_URL}/playground/join/${param.roomId}`;
        ...
        <div className="flex flex-col gap-4 mt-2">
          <div className="flex flex-col gap-1">
            ...
            <div className="flex items-center gap-2">
              <div className="flex  items-center gap-2 px-3 py-2 w-full rounded-md bg-[#1e1e1e] border border-[#2d2d30] text-xs truncate">
